...
def apply_instance_tuning(bridge, requested_plank_count, apply_long_tuning):
    ...
    if apply_long_tuning:
        ...
        instance_settings.set_editor_property("direct_hit_impulse_scale", 0.05)
        instance_settings.set_editor_property("maximum_direct_hit_impulse", 50.0)
        instance_settings.set_editor_property("attack_response_linear_damping_multiplier", 4.0)
        instance_settings.set_editor_property("attack_response_angular_damping_multiplier", 6.0)
        instance_settings.set_editor_property("attack_response_damping_grace_time", 1.0)
